...
<html lang="en">
 ...
 //session_start();
  ...
  <form method="get" action="<?php echo $base_url.'customer/search' ?>">
  <table>
  ...
  <?php
   if(isset($_POST['submit'])){
	  session_destroy();
	  header('Location: http://localhost/project5/index.php/customer/page1');
  }
  if(isset($_POST['shopping'])){
	  header("location: http://localhost/project5/index.php/customer/page3");
  }
  ?>
  </div>
 </body>
